...
'''
#variables are labels which act as containers to hold and store data 

#assignment operator(=) assigns values to a variable tag

message1="hello there hope you are good"
